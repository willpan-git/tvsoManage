 ...
 */
@Api(value = "API - EquipController", protocols = "json", tags = { "Equipment" })
@RestController
...
public class EquipController {
    ...
    public void updateEquip(@RequestBody(required = true) Equip equip) {
	// 判断设备是否存在
	Equip equipTemp = equipService.findEquipById(equip.getToeiId());
	if (equipTemp == null) {
	    throw new MyException(ResultEnum.UnknowEquipException);
	} else {
	    // 调用更新方法
