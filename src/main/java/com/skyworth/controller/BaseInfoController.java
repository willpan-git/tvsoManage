...
public class BaseInfoController {
    ...
    public Result<?> addParameterCode(@RequestBody(required = true) Parameter parameter) {
	// 新增
    ...
    public Result<?> updateParameterCode(@RequestBody(required = true) Parameter parameter) {
	// 修改
    ...
    public Result<?> unableParameterCode(Integer codeId) {
	// 失效
    ...
    public Result<?> effectParameterCode(Integer codeId) {
	// 生效
    ...
    public Result<?> deleteParameterCode(Integer codeId) {
    ...
    public Result<?> fingParameterById(Integer codeId) {
	try {
	    // 返回信息
	    ResultEnum resultEnum = ResultEnum.SUCCESS;
	    return ResultUtil.getSuccess(resultEnum.getCode(), resultEnum.getMsg(),
		    baseInfoService.findParameterById(codeId));
	} catch (Exception e) {
	    // 打印错误日志
